...
[horizontal]
Github:: image:https://github.com/baldir-fr/template-asciidoctor-dockerized/actions/workflows/generate-docs-and-publish-with-github-pages.yml/badge.svg[Generate and deploy static content to Pages,link=https://github.com/baldir-fr/template-asciidoctor-dockerized/actions/workflows/generate-docs-and-publish-with-github-pages.yml]

Gitlab:: image:https://gitlab.com/marc-bouvier/template-asciidoctor-dockerized/badges/main/pipeline.svg[Gitlab pipeline status,link="https://gitlab.com/marc-bouvier/template-asciidoctor-dockerized/-/pipelines",title="gitlab pipeline status"]
