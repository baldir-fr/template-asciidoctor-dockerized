...
Gitlab:: image:https://gitlab.com/marc-bouvier/template-asciidoctor-dockerized/badges/main/pipeline.svg[link="https://gitlab.com/marc-bouvier/template-asciidoctor-dockerized/-/commits/main",title="gitlab pipeline status"]
